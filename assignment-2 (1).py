...
2) Determine the frequency of highest occurence
3) Check whether given string is palindrome or not
4) Display the index of first occurence of the substrng.
5)To count the occurence of each word in the string.
hello good morning'''
